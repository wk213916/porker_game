...
require_relative '../../src/three_card_ver/game'
...
describe "Game" do
  describe "２つの手札の役が異なる場合の比較" do
    context "player_handの方が強い場合" do
      ...
      it "player_handが勝ち、cpu_handが負ける" do
        game.judge_result
        expect(game.judge.player_winning).to eq GameResult::Win
        expect(game.judge.cpu_winning).to eq GameResult::Lose
      end
    end
    context "cpu_handの方が強い場合" do
      ...
      it "player_handが負け、cpu_handが勝つ" do
        game.judge_result
        expect(game.judge.player_winning).to eq GameResult::Lose
        expect(game.judge.cpu_winning).to eq GameResult::Win
      end
    end
  end
