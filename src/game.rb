...
game.hands[:player_hand].role = game.hands[:player_hand].cards[0].check_hand_card(game.hands[:player_hand].cards[1])
game.hands[:cpu_hand].role = game.hands[:cpu_hand].cards[0].check_hand_card(game.hands[:cpu_hand].cards[1])
game.judge_result
